...
export const THEMES: ThemeDefinition[] = [
  ...
  },
  {
    id: "blossom-pink",
    name: "블라썸 핑크",
    description: "사랑스러운 핑크 톤으로 화사한 분위기의 테마",
    preview: ["#f472b6", "#f9a8d4", "#fff0f6"],
    values: {
      "--background": "hsl(330, 80%, 98%)",
      "--foreground": "hsl(330, 20%, 20%)",
      "--card": "hsl(0, 0%, 100%)",
      "--card-foreground": "hsl(330, 20%, 20%)",
      "--popover": "hsl(0, 0%, 100%)",
      "--popover-foreground": "hsl(330, 20%, 20%)",
      "--primary": "hsl(330, 78%, 70%)",
      "--primary-foreground": "hsl(0, 0%, 100%)",
      "--secondary": "hsl(330, 88%, 92%)",
      "--secondary-foreground": "hsl(330, 30%, 25%)",
      "--muted": "hsl(330, 45%, 90%)",
      "--muted-foreground": "hsl(330, 25%, 40%)",
      "--accent": "hsl(336, 84%, 67%)",
      "--accent-foreground": "hsl(0, 0%, 100%)",
      "--destructive": "hsl(0, 74%, 58%)",
      "--destructive-foreground": "hsl(0, 0%, 100%)",
      "--border": "hsl(330, 45%, 84%)",
      "--input": "hsl(330, 45%, 84%)",
      "--ring": "hsl(330, 78%, 70%)",
      "--chart-1": "hsl(330, 78%, 70%)",
      "--chart-2": "hsl(336, 84%, 67%)",
      "--chart-3": "hsl(201, 100%, 46%)",
      "--chart-4": "hsl(142, 44%, 57%)",
      "--chart-5": "hsl(42, 92%, 56%)",
      "--sidebar": "hsl(330, 80%, 96%)",
      "--sidebar-foreground": "hsl(330, 20%, 20%)",
      "--sidebar-primary": "hsl(330, 78%, 70%)",
      "--sidebar-primary-foreground": "hsl(0, 0%, 100%)",
      "--sidebar-accent": "hsl(336, 84%, 67%)",
      "--sidebar-accent-foreground": "hsl(0, 0%, 100%)",
      "--sidebar-border": "hsl(330, 45%, 84%)",
      "--sidebar-ring": "hsl(330, 78%, 70%)",
      "--theme-color": "#f472b6",
    },
  },
  {
  ...
  },
  {
    id: "sunflower-glow",
    name: "선플라워 글로우",
    description: "밝은 옐로우와 골드 포인트로 생기 넘치는 테마",
    preview: ["#facc15", "#fef08a", "#fffbea"],
    values: {
      "--background": "hsl(50, 90%, 97%)",
      "--foreground": "hsl(38, 40%, 18%)",
      "--card": "hsl(0, 0%, 100%)",
      "--card-foreground": "hsl(38, 40%, 18%)",
      "--popover": "hsl(0, 0%, 100%)",
      "--popover-foreground": "hsl(38, 40%, 18%)",
      "--primary": "hsl(48, 96%, 58%)",
      "--primary-foreground": "hsl(38, 50%, 12%)",
      "--secondary": "hsl(50, 100%, 88%)",
      "--secondary-foreground": "hsl(40, 35%, 22%)",
      "--muted": "hsl(45, 70%, 90%)",
      "--muted-foreground": "hsl(40, 30%, 40%)",
      "--accent": "hsl(44, 95%, 60%)",
      "--accent-foreground": "hsl(38, 50%, 12%)",
      "--destructive": "hsl(0, 74%, 58%)",
      "--destructive-foreground": "hsl(0, 0%, 100%)",
      "--border": "hsl(45, 65%, 82%)",
      "--input": "hsl(45, 65%, 82%)",
      "--ring": "hsl(48, 96%, 58%)",
      "--chart-1": "hsl(48, 96%, 58%)",
      "--chart-2": "hsl(44, 95%, 60%)",
      "--chart-3": "hsl(142, 44%, 57%)",
      "--chart-4": "hsl(201, 100%, 46%)",
      "--chart-5": "hsl(336, 84%, 67%)",
      "--sidebar": "hsl(50, 90%, 96%)",
      "--sidebar-foreground": "hsl(38, 40%, 18%)",
      "--sidebar-primary": "hsl(48, 96%, 58%)",
      "--sidebar-primary-foreground": "hsl(38, 50%, 12%)",
      "--sidebar-accent": "hsl(44, 95%, 60%)",
      "--sidebar-accent-foreground": "hsl(38, 50%, 12%)",
      "--sidebar-border": "hsl(45, 65%, 82%)",
      "--sidebar-ring": "hsl(48, 96%, 58%)",
      "--theme-color": "#facc15",
    },
  },
  {
